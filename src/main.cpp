...
unsigned int nStakeMinAge = 60 * 60 * 12 * 1;	// minimum age for coin age: 1/2d
...
int64 nChainStartTime = 1483651156;
...
const string strMessageMagic = "Jolt Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in Jolt
    bool fStrictPayToScriptHash = true; // Always active in Jolt
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Jolt", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "January 5 2017, Jolt Baby! 1479084493.";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("b3f0b821ff632d6210d4e57043e139213fab79cb9c634eae63a2d6227a628e13"));
